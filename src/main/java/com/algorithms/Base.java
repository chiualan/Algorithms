...
public abstract class Base
{
    ...
    public static final String OUTPUT_LINE_FORMAT = "Case #%d\n%s\n";
    ...
    {
        final int numberOfCases = getNumberOfCases(reader);
    ...
    private int getNumberOfCases(final BufferedReader reader) throws IOException
    {
        try
        {
